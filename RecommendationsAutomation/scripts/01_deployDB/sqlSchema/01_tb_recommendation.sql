...
(
    ...
    [Category] NVARCHAR(50) NOT NULL CHECK ([Category] IN ('Cost', 'Security', 'Reliability', 'OperationalExcellence', 'Performance')),
    ...
    [StatusAction] NVARCHAR(50) CHECK ([StatusAction] IN ('TO_SYNC_WITH_SOURCE','SOURCE_UPDATED')),
    [StatusActionExternalId]  NVARCHAR(255),
